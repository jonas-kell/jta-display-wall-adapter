...
REM Parameters
set "PARAMS=server --listen-to-timing-program --passthrough-address-display-program 192.168.150.10 --address-camera-program 192.168.150.10 --wait-ms-before-testing-for-shutdown=5000 --passthrough-to-display-program --address-internal-communication=192.168.150.150 --internal-communication-port 5678 --dp-pos-x=0 --dp-pos-y=0 --dp-width=360 --dp-height=120"
