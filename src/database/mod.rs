...
pub use database_mapping::{
    ...
    get_all_heat_assignments, get_database_static_state, get_heat_data, get_log_limited,
    get_wind_readings, init_database_static_state, purge_heat_data, ApplicationMode,
