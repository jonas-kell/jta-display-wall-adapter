...
fn parse_clear_command(input: &[u8]) -> IResult<&[u8], InstructionFromTimingClient> {
    const CLEAR_MARKER: [u8; 40] = [
        0x44, 0x69, 0x73, 0x70, 0x6C, 0x61, 0x79, 0x42, 0x6F, 0x61, 0x72, 0x64, 0x2E, 0x43, 0x6F,
        0x6D, 0x6D, 0x75, 0x6E, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x2E, 0x50, 0x61, 0x63,
        0x6B, 0x65, 0x74, 0x73, 0x2E, 0x43, 0x6C, 0x65, 0x61, 0x72,
    ];

    let (input, _) = take_until_and_consume(&CLEAR_MARKER[..], input)?;

    // 

    Ok((input, InstructionFromTimingClient::Clear))
}

fn parse_slideshow_command(input: &[u8]) -> IResult<&[u8], InstructionFromTimingClient> {
    const SLIDESHOW_MARKER: [u8; 41] = [
        0x42, 0x61, 0x63, 0x6B, 0x69, 0x6E, 0x67, 0x46, 0x69, 0x65, 0x6C, 0x64, 0x00, 0x01, 0x01,
        0x00, 0x08, 0x01, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x0A, 0x00, 0x00,
        0x00, 0x09, 0x53, 0x6C, 0x69, 0x64, 0x65, 0x73, 0x68, 0x6F, 0x77,
    ];

    let (input, _) = take_until_and_consume(&SLIDESHOW_MARKER[..], input)?;

    // 

    Ok((input, InstructionFromTimingClient::Advertisements))
}
...
fn parse_any_known_command(input: &[u8]) -> IResult<&[u8], InstructionFromTimingClient> {
    alt((
        ...
        |i| parse_clear_command(i),
        |i| parse_slideshow_command(i),
    ))
    .parse(input)
}
